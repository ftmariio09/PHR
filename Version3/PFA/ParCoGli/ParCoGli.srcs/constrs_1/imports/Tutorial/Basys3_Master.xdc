...
#PARCOGLI bombaInsGlargina, bombaInsLispro ACTUALIZAR A MOTOR CUADRAFASICO 3 amarillo, 2 naranja, 1 marron, 0 negro

#Pmod Header JB
#Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {bombaInsGlargina[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsGlargina[0]}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {bombaInsGlargina[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsGlargina[1]}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {bombaInsGlargina[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsGlargina[2]}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {bombaInsGlargina[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsGlargina[3]}]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {bombaInsLispro[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsLispro[0]}]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {bombaInsLispro[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsLispro[1]}]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {bombaInsLispro[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsLispro[2]}]
#Sch name = JB10
set_property PACKAGE_PIN C16 [get_ports {bombaInsLispro[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsLispro[3]}]
...
#UNA VERSION DE PRACTICAS DE XADC TENIA ESTO, A LO MEJOR ES UTIL
#On the Basys3, the XADC Pmod connector houses 4 differential analog pairs. The corresponding XADC channels are 6, 7, 14, and 15.
#The differential pairs are grouped by columns. Looking at the number above, 1 corresponds to XA1_P and XA1_N, column 2 routes to XA2_P and XA2_N,
#3 routes to XA3_P and XA3_N, and 4 routes to XA4_P and XA4_N.
#Pmod Header JXADC
#Sch name = XA1_P
