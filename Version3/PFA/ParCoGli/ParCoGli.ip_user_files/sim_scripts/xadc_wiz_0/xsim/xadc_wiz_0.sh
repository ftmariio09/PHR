...
#
# Generated by Vivado on Thu Apr 28 12:29:52 +0200 2022
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot xadc_wiz_0 xil_defaultlib.xadc_wiz_0 -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/Xilinx2021/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
