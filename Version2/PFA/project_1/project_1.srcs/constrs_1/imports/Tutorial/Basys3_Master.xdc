...
#EL LED RGB DE NUESTRO PFA, 0 es R, 1 es G, 2 es B
...
#PARCOGLI bombaInsGlargina, bombaInsLispro
set_property PACKAGE_PIN A14 [get_ports {bombaInsGlargina}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsGlargina}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {bombaInsLispro}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bombaInsLispro}]
	#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {bombaGlucosa}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {bombaGlucosa}]
##Pmod Header JB
##Sch name = JB1
