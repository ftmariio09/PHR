...
REM
REM Generated by Vivado on Tue Apr 26 10:09:43 +0200 2022
...
echo "xvhdl --incr --relax -prj Conversor_vhdl.prj"
call xvhdl  --incr --relax -prj Conversor_vhdl.prj -log xvhdl.log
